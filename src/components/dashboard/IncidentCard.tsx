...
const IncidentCard = ({
  ...
  return (
    <div className="glass-card rounded-xl p-4 border border-border/50 hover:border-primary/30 transition-colors">
      <div className="flex items-start justify-between mb-3">
        ...
        <span className={cn("text-xs font-medium px-2 py-1 rounded-full", sta.bg, sta.color)}>
          {sta.label}
        </span>
      </div>
